...
const TrainingCard = ({ training, index }) => (
  <motion.div
    ...
    className=" p-5 rounded-xl shadow-lg border-l-4 border-purple-600 flex flex-col sm:flex-row gap-5 items-start"
  >
    {training.logo && (
      <img
        src={training.logo}
...
//   <motion.div
//     variants={fadeIn("up", "spring", index * 0.3, 0.75)}
// ____________    className="bg-[#1a1a2e] p-5 rounded-xl shadow-lg border-l-4 border-purple-600 flex flex-col sm:flex-row gap-5 items-start"
//   >
//     {training.logo && (
//       <img
//         src={training.logo}
